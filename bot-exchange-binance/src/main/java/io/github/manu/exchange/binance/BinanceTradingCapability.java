...
record BinanceTradingCapability(
        ...
        String cancelAllOpenOrdersByUnderlyingPath,
    ...
    static BinanceTradingCapability fromConfig(BinanceProperties.Trading trading) {
        return new BinanceTradingCapability(
                ...
                trading.sorOrderPath(),
                trading.sorTestOrderPath(),
                trading.orderListOcoPath(),
                trading.orderListOtoPath(),
                trading.orderListOtocoPath(),
                trading.orderListOpoPath(),
                trading.orderListOpocoPath(),
